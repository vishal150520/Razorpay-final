...
public class PaymentService : IPaymentService
{
    ...
    public Task<MerchantOrder> ProcessMerchantOrder(PaymentRequest payRequest)
    {
        try
        {
            ...
            Razorpay.Api.RazorpayClient client = new Razorpay.Api.RazorpayClient("rzp_test_07OH6LW4RTVnBI", "ilf3VShPQ29u0R2ngiHLTEPX");
            ...
            MerchantOrder order = new MerchantOrder
            {
                ...
                RazorpayKey = "rzp_test_07OH6LW4RTVnBI",
